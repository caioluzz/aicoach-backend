...
public interface ConfigurationApi {
    ...
    @PutMapping("/athletes/{athleteId}/openai")
    ConfigurationStatusResponse updateOpenAi(@PathVariable Long athleteId,
                                             @Valid @RequestBody OpenAiConfigurationRequest request);

    @PostMapping("/athletes/{athleteId}/openai/test")
    IntegrationTestResponse testOpenAi(@PathVariable Long athleteId);
}
